...
// ROTATION
public class AF_COLOR_N2   extends Block_Prototype_Fxy {
  ...
  public void paint(FW_ImageContext ct, int depth) {
   ...
   //  r1 = f(ct.pX(),ct.pY(),1);
    ...
    if(r2<0.33){
       ...
       r2=r2*r;
       r=1.0-r;
	   rr1 = (int) (ar * r + br * r1+ cr * r2);
       gg1 = (int) (ag * r + bg * r1+ cg * r2);
       bb1 = (int) (ab * r + bb * r1+ cb * r2);
       ct.pSet(rr1, gg1, bb1);     
     }
     else if(r2<0.66){
	   r2=(r2-0.33)*3;
       ...
       r2=r2*r;
       r=1.0-r;
	   rr1 = (int) (ar * r + cr * r1+ dr * r2);
       gg1 = (int) (ag * r + cg * r1+ dg * r2);
       bb1 = (int) (ab * r + cb * r1+ db * r2);
       ct.pSet(rr1, gg1, bb1);     
     }
     else {
	   r2=(r2-0.66)*2.9;
       ...
       r2=r2*r;
       r=1.0-r;
	   rr1 = (int) (ar * r + dr * r1+ er * r2);
       gg1 = (int) (ag * r + dg * r1+ eg * r2);
       bb1 = (int) (ab * r + db * r1+ eb * r2);
       ct.pSet(rr1, gg1, bb1);     
     }
