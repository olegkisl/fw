...
public class A1_HILL_MIR_2 extends Block_Prototype_Fxy {
    ...
    public A1_HILL_MIR_2() {
        super(" A1_HILL_MIR_2", 2, 20);
    }
    ...
    public double f(double x, double y) {
        ...
        double cf = 0.2;
        double bright = 0.5+0.5*params[11];
        double yy = fff(x);
