...
public class f_rubensH_Z   extends Block_Prototype_Fxy {
static final long serialVersionUID =1L;
//  double sc = 10.0;
  public f_rubensH_Z() {
     super("rubensH_Z", 3, 10);
  }
  ...
  // double ttt = ggg.f(x,y);
   double u = params[5]*tt;
   double v = params[2]*t+params[3]*tt;
   double r = (ggg.f(x,y)+u*(ggg.f(x+params[7]*v,y)+ggg.f(x,y+params[8]*v)))/(1+u*u);
   return r;
  }
