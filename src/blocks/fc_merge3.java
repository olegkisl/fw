...
public class fc_merge3   extends Block_Prototype_Fxy_C {
static final long serialVersionUID =1L;
  ...
  if (ttt>1) ttt =1/ttt;
   ...
   double u = t+tt+ttt+0.0001;

   double a = t/u;
   double b = tt/u;
   double c = ttt/u;
   clr.r =color_r[0]*a + color_r[1]*b + color_r[2]*c;
   clr.g =color_g[0]*a + color_g[1]*b + color_g[2]*c;
   clr.b =color_b[0]*a + color_b[1]*b + color_b[2]*c;
   return  clr;
  }
