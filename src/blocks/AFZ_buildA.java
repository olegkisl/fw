...
public class AFZ_buildA   extends Block_Prototype_Fxy {
static final long serialVersionUID =1L;
  ...
  public void createH(){
    ...
    for(int i =0; i<14; i++){
      ...
      dxx[i] =cc*Math.cos(alfa*i);
      dxy[i] =cc*Math.sin(alfa*i);
      dxc[i]=0;

      dyx[i] =-cc*(Math.sin(alfa*i)+0.5*params[6]);
      dyy[i] =cc*Math.cos(alfa*i);
      dyc[i]= 0;
