   ...
   { public  double x,y;
     ...
     public  P2(double x1,double y1)
      ...
      { double x1,y1;
        x1=x;
        y1=y;
        x=x1*t.h[0][0]+y1*t.h[1][0]+t.h[2][0];
        y=x1*t.h[0][1]+y1*t.h[1][1]+t.h[2][1];
       }
   }

//////////////////////////////////////////////////////////////
/*
class  Geom //abstract base class for geom obgects
{
...
protected void draw0(Tr2 t,Graphics c,int cr,int cg,int cb){}//Must be redefine by individual obj.

void draw1(Tr2 t,Graphics c,int cr,int cg,int cb)
{
    if(cr<0) cr=0;
        if(cr>255) cr=255;
        if(cg<0) cg=0;
...
public void draw(Tr2 t,Graphics c)
        {
    int cr = (int)(255*r);
        int cg = (int)(255*g);
        int cb = (int)(255*b);
...
public void draw(Tr2 t,Graphics c,double brt)//draw with this britness
    {
...
public void draw(Tr2 t,Graphics c,double r1,double g1,double b1)//draw with this color
    {
    int cr = (int)(255*r1);
        int cg = (int)(255*g1);
        int cb = (int)(255*b1);
...
public void drawAddColor(Tr2 t,Graphics c,double r1,double g1,double b1)//draw with add color
    {
...
public void drawMultColor(Tr2 t,Graphics c,double r1,double g1,double b1)//draw with mult color
    {
    int cr = (int)(255*(r1*r));
        int cg = (int)(255*(g1*g));
        int cb = (int)(255*(b1*b));
...
public void draw0(Tr2 t,Graphics c,int cr,int cg,int cb)
        {
...
protected void draw0(Tr2 t,Graphics c,int cr, int cg,int cb)
        {
...
public void draw(Tr2 t,Graphics c,double r1,double g1,double b1)
        {
        for (Enumeration  e  =  v.elements()  ;  e.hasMoreElements()  ;)
                {
...
public void drawAddColor(Tr2 t,Graphics c,double r1,double g1,double b1)
        {
        for (Enumeration  e  =  v.elements()  ;  e.hasMoreElements()  ;)
                {
...
public void drawMultColor(Tr2 t,Graphics c,double r1,double g1,double b1)
        {
        for (Enumeration  e  =  v.elements()  ;  e.hasMoreElements()  ;)
                {
...
public void draw(Tr2 t,Graphics c, double brt)
        {
        for (Enumeration  e  =  v.elements()  ;  e.hasMoreElements()  ;)
                {
