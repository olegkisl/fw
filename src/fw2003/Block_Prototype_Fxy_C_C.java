...
public class Block_Prototype_Fxy_C_C extends Block_Prototype {
...
public Block_Prototype_Fxy_C_C(String name, int nson, int nparam) {
    super(name, name, nson, Block_Prototype_Fxy_C.class );
